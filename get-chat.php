...
if(isset($_GET['username'])){
	...
	$messages = DB::query("SELECT * FROM messages WHERE (sender=:sender AND reciever=:reciever) OR (reciever=:sender AND sender=:reciever) ", array(":reciever"=>$userid, ":sender"=>$otherId));
...
<a href="get-chat.php?username=<?php echo $_GET['username']; ?>" class="button"><i class='material-icons'>refresh</i></a>
</div>
</body>
